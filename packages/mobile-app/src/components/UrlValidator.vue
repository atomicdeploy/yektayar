...
<template>
  <!-- Error Screen -->
  <IonPage v-if="showError">
    <IonContent class="url-mismatch-error">
      <div class="error-content">
        ...
        <div class="error-details">
          <p>این برنامه برای اجرا در این آدرس پیکربندی شده است:</p>
          <p>This application is configured to run at:</p>
        ...
        <div class="error-solution">
          ...
          <ul>
            ...
            <li>یا از آدرس صحیح به برنامه دسترسی داشته باشید</li>
            <li>Or access the app from the correct URL</li>
          </ul>
        </div>
      </div>
    </IonContent>
