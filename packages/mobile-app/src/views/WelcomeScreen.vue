      ...
      <div class="welcome-container">
        ...
        <div class="welcome-text">
          <p class="welcome-paragraph highlight-first">
            به <strong>یکتایار</strong>strong> خوش اومدی؛ جایی که دیگه لازم نیست مشکلاتت رو توی دلت نگه داری.
          ...
          <p class="welcome-paragraph">
            از مشاوره و روان‌درمانی فردی گرفته تا زوج‌درمانی و خانواده درمانی ، همه‌چی اینجا آمادست تا هر چه سریع‌تر، <em>آرامش</em>، <em>امنیت</em> و <em>حال خوب</em> به زندگیت بیاد.
          </p>
          <p class="welcome-paragraph">
