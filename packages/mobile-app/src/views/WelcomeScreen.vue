      ...
      <div class="welcome-container">
        ...
        <div class="welcome-text">
          <p class="welcome-paragraph highlight-first">
            به یکتایار خوش اومدی؛ جایی که دیگه لازم نیست مشکلاتت رو توی دلت نگه داری.
 اینجا خیلی راحت میتونی حرف بزنی، احساساتت رو بگی و دغدغههات رو مطرح کنی و   فورا یک نقشه مسیر علمی برای حل مشکلاتت بگیری.
          </p>
          <p class="welcome-paragraph">
            در یکتایار دیگه خبری از سردرگمی و اتلاف وقت نیست فورا در مسیر درست حل مشکلاتت قرار میگیری در کنارش سریعترین راه برای گرفتن وقت جلسات مشاوره جلوی پاته و مطمئن میشی که همیشه یه تیم پشتیبان هم کنارت هست.
          </p>
          <p class="welcome-paragraph">
            از مشاوره و روان درمانی فردی گرفته تا زوجدرمانی و خانواده درمانی ، همهچی اینجا آمادهست تا هر چه سریعتر ، آرامش، امنیت و حال خوب به زندگیت بیاد.
          </p>
          <p class="welcome-paragraph">
