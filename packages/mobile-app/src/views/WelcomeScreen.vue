      ...
      <div class="welcome-container">
        ...
        <div class="welcome-text">
          <p class="welcome-paragraph highlight-first">
            به یکتایار خوش اومدی؛ جایی که دیگه لازم نیست مشکلاتت رو توی دلت نگه داری. اینجا خیلی راحت میتونی حرف بزنی، احساساتت رو بگی و دغدغههات رو مطرح کنی. همون لحظه میفهمی باید پیش کدوم مشاور یا تراپیست بری و وقت بگیری.
          </p>
          <p class="welcome-paragraph">
            یکتایار مسیر رو برات کوتاه کرده؛ دیگه خبری از سردرگمی و اتلاف وقت نیست. سریعترین راه برای گرفتن وقت مشاوره جلوی پاته و مطمئن میشی که همیشه یه تیم پشتیبان کنارت هست.
          </p>
          <p class="welcome-paragraph">
            از مشاوره فردی گرفته تا زوجدرمانی و خانواده، همهچی توی یکتایار آمادهست تا آرامش، امنیت و حال خوب دوباره برگرده به زندگیت.
          </p>
          <p class="welcome-paragraph">
            با یکتایار، انتخاب درست همیشه دم دستته؛ فقط کافیه شروع کنی و ببینی چطور همهچیز یکییکی سر جاش قرار میگیره.
          </p>
        </div>
