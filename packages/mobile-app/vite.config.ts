 ...
 * @param baseUrl - The base URL (e.g., https://app.yektayar.ir)
...
export default defineConfig(({ mode }) => {
  ...
  const baseUrl = process.env.MOBILE_APP_BASE_URL;
  
  // Determine HMR client port:
  // 1. Use VITE_HMR_CLIENT_PORT if explicitly set
  // 2. Otherwise, auto-detect from MOBILE_APP_BASE_URL
  ...
  return {
    ...
    server: {
      ...
      hmr: {
        ...
        // Auto-detected from MOBILE_APP_BASE_URL or VITE_HMR_CLIENT_PORT
