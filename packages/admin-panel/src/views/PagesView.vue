<template>
  <div>
    ...
    <div class="mb-8 flex justify-between items-center">
      <div>
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">مدیریت صفحات</h1>
        <p class="mt-2 text-gray-600 dark:text-gray-400">مشاهده و ویرایش محتوای صفحات</p>
      </div>
      <button
        @click="createNewPage"
    ...
    <div v-else-if="pages.length > 0" class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
          <tr v-for="page in pages" :key="page.id" class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
    ...
    <div v-else class="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center">
      ...
      <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">صفحه‌ای وجود ندارد</h3>
      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">برای شروع یک صفحه جدید ایجاد کنید</p>
      <div class="mt-6">
        <button
          @click="createNewPage"
          class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors"
