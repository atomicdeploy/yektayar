export default {
  ...
  not_found: {
    ...
    requested_url: 'آدرس درخواستی',
    request_method: 'نوع درخواست',
    timestamp: 'زمان درخواست',
    user_agent: 'مرورگر کاربر',
    referrer: 'منبع ارجاع',
    query_params: 'پارامترهای جستجو',
    debug_info: 'اطلاعات اشکال‌زدایی',
    route_name: 'نام مسیر',
    matched_pattern: 'الگوی تطابق',
    full_path: 'مسیر کامل',
    hash: 'هش',
    copy_debug_info: 'کپی اطلاعات اشکال‌زدایی',
    debug_info_copied: 'اطلاعات اشکال‌زدایی در کلیپ‌بورد کپی شد!',
    direct_access: 'دسترسی مستقیم',
    none: 'هیچ',
    suggestions: 'پیشنهادات',
    suggestion_1: 'آدرس URL را برای اشتباه تایپی یا خطا بررسی کنید',
    suggestion_2: 'از منوی ناوبری برای یافتن مورد نظر استفاده کنید',
    suggestion_3: 'به داشبورد برگردید و دوباره شروع کنید',
    suggestion_4: 'محتوای مورد نیاز خود را جستجو کنید',
    helpful_links: 'لینک‌های سریع',
    search_placeholder: 'جستجو در پنل مدیریت...',
  },
}
