...
3. **[Getting Started Guide](GETTING-STARTED.md)** - Comprehensive onboarding for new developers
...
- **[Bun vs NPM](BUN-VS-NPM.md)** - Understanding runtime choices
- **[Network Configuration](NETWORK-CONFIGURATION.md)** - Interface and port configuration

#### Deployment
- **[Ubuntu 24.04 Deployment](UBUNTU-24-DEPLOYMENT.md)** - VPS deployment guide for Ubuntu
...
- Found outdated information? [Open an issue](https://github.com/atomicdeploy/yektayar/issues)
- Need clarification? [Start a discussion](https://github.com/atomicdeploy/yektayar/discussions)
...
- [ ] All files listed in this index exist
...
**Quick Links:**
- [Main README](../README.md) | [Quick Start](../QUICK-START.md) | [Getting Started](GETTING-STARTED.md) | [Development](../DEVELOPMENT.md) | [Architecture](ARCHITECTURE.md)
